...
namespace Azul
{
	void ConvertSkin(const char *const pName, const char *const pTargetName, int meshNum = 0);
	void ConvertInvBind(const char *const pName, const char *const pTargetName, int meshNum = 0);
	class Convert
	{
	public:
		static void SetVBO(
