...
namespace Azul
{
	...
	ShaderObject_SkinLightTexture::ShaderObject_SkinLightTexture(ShaderObject_SkinLightTexture::Name _name)
		: ShaderObject(_name)
	{
		this->CreateVertexShader(g_SkinLightTexture_VxShader, sizeof(g_SkinLightTexture_VxShader));
		...
		this->CreateInputLayout(g_SkinLightTexture_VxShader,
								sizeof(g_SkinLightTexture_VxShader),
								vertexLayoutDesc,
								sizeof(vertexLayoutDesc));

		this->CreatePixelShader(g_SkinLightTexture_PxShader,
								sizeof(g_SkinLightTexture_PxShader));
