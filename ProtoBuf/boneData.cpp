...
namespace Azul
{
	...
	/*boneData::boneData(const boneData &b)
	{
		this->S.set(b.S.x, b.S.y, b.S.z);
		this->Q.set(b.Q.qx, b.Q.qy, b.Q.qz, b.Q.qw);
		this->T.set(b.T.x, b.T.y, b.T.z);
	}

	boneData &boneData::operator = (const boneData &b)
	{
		this->S.set(b.S.x, b.S.y, b.S.z);
		this->Q.set(b.Q.qx, b.Q.qy, b.Q.qz, b.Q.qw);
		this->T.set(b.T.x, b.T.y, b.T.z);
	...
	boneData::boneData(Vec3 &s, Quat &q, Vec3 &t)
		: S(s),
		Q(q),
		T(t)
	{
	...
	void boneData::set(Vec3 &s, Quat &q, Vec3 &t)
	{
		this->S.set(s);
		this->Q.set(q);
		this->T.set(t);
